# incializace parametrického reportu - volá template pro konkrétní kraj a datum
...
for (i in seq_along(kraje)) { # tj. od jedničky do čtrnáckty
   ...
   render("./extras/par-report-template.Rmd", # Rmd template, včetně cesty
